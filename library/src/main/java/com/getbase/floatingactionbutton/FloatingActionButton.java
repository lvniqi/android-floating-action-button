...
public class FloatingActionButton extends ImageButton {
    ...
    ArrayList<View> subButtons = null;

    public void addSubButtons(View button) {
        if (subButtons == null) {
            subButtons = new ArrayList<View>();
    ...
    public ArrayList<View> getSubButtons() {
        return subButtons;
    }

    boolean titleHideFlag = false;

    public void setTitleHide(boolean flag) {
        titleHideFlag = flag;
    }

    public boolean isTitleHide() {
        return titleHideFlag;
    }
}
